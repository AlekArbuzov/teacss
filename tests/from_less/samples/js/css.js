tea.start('from_less/samples/cases/css.tea',1);
...
tea.f("#shorthands", function(){
  ...
  tea.print("background: url(\"http://www.lesscss.org/spec.html\") no-repeat 0 4px");
});
...
tea.f(".misc", function(){
  ...
  tea.print("background: -webkit-gradient(linear, left top, left bottom, from(#ff0000), to(#0000ff))");
  tea.print("margin:"); 
