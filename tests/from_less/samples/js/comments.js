tea.start('from_less/samples/cases/comments.tea',1);
/******************\
*                  *
*  Comment Header  *
*                  *
...
tea.f("#comments /* boo */", function(){
  /**/ // An empty comment
  tea.print("color: "+(color('red'))+""); /* A C-style comment */
  tea.print("background-color: "+(color('orange'))+""); // A little comment
...
tea.f(".selector /* .with */, .lots, /* of */ .comments", function(){
  tea.print("color: grey, /* blue */ "+(color('orange'))+"");
  tea.print("-webkit-border-radius: 2px /* webkit only */");
  tea.print("-moz-border-radius: "+(2 * 4)+"% /* moz only with operation */");
});
